...
export interface BoardOptions {
     ...
     * @type Object
     * @defaultValue <tt>{x: {name:'x'} y: {name: 'y'}}</tt>
     *
     * @example
     ...
     *
     * @name JXG.Board#drag
     * @defaultValue <tt>{enabled: true}</tt>
     */
     ...
     * @defaultValue svg code
     * @see JXG.Board#showFullscreen
     * @see JXG.AbstractRenderer#drawNavigationBar
     */
    fullscreen?: { symbol: string, scale: number, id?: string | null }
     ...
     *
     * @name JXG.Board#intl
     * @defaultValue <tt>{enabled: false}</tt>
     * @see Integral#label
     * @see Slider#intl
     * @see Text#intl
     * @see Ticks#intl
     ...
     * @type Object
     * @defaultValue <tt>{enabled: true dx: 10, dy:10, panShift: true panCtrl: false}</tt>
     */
    keyboard?: {
        enabled: boolean
        dx: number
     ...
     * @see JXG.Board#boundingBox
     * @defaultValue [-Infinity, Infinity, Infinity, -Infinity]
     *
     * @example
     * var board = JXG.JSXGraph.initBoard('jxgbox', {
     *         boundingBox: [-5, 5, 5, -5],
     ...
     * @defaultValue <tt>{enabled: true throttle: 10}</tt>
     *
     * @example
     *     var board = JXG.JSXGraph.initBoard('jxgbox', {
     *         boundingbox: [-5,5,5,-5],
    ...
    */
     ...
     * <b>aria:{enable:truelabel:"Your Title"}</b>
     *
 ...
 *
 */
export interface NavbarOptions {   // deprecated !!!
    strokeColor: string
    fillColor: string //#f5f5f5',
    highlightFillColor: string // '#aaaaaa',
    padding: string //'2px',
    position: string //'absolute',
    fontSize: string //'14px',
    cursor: 'pointer' | 'help' | 'wait' | 'crosshair' | 'not-allowed' | 'zoom-in' | 'grab',  // TODO : where not depreciated ?
    zIndex: string //'100',
    right: string //'5px',
    bottom: string //'5px'
 ...
 */
export interface GeometryElementOptions {
    ...
    aria?: {
        enabled?: boolean
        label?: string
        live?: 'assertive' | 'polite' | 'none' // 'assertive', 'polite', 'none'
    }
    ...
    */
     ...
     * @defaultValue See {@link JXG.Options#layer}
     */
    layer?: number
     ...
     */
    precision?: 'inherit' | PrecisionOptions
     ...
     *
     */
    traceAttributes?: { color?: string, face?: string }
     ...
     * @see JXG.GeometryElement#fillOpacity
     * @see JXG.GeometryElement#highlightFillOpacity
     * @defaultValue 100 {@link JXG.Options.elements#transitionDuration}
     */
     ...
     *
     */
    transitionProperties?: string[]   // TODO: expand this
     ...
     */
    ignoreForLabelAutoposition?: boolean
}
...
export interface TickOptions {
    ...
    * @type Array
    ...
    minorTicksInArrow: boolean
    majorTicksInArrow: boolean
    labelInArrow: boolean
    minorTicksInMargin: boolean
    majorTicksInMargin: boolean
    labelInMargin: boolean
...
export interface AngleOptions {
     ...
     * @name Angle#dot
     * @type Object
     * @defaultValue <tt>{face: 'o', size: 2}</tt>
     */
    dot?: {
        visible?: boolean
        strokeColor?: string,
...
export interface AxisOptions {
    ...
    name?: string                            // By default, do not generate names for axes.
    needsRegularUpdate?: boolean           // Axes only updated after zooming and moving of the origin.
    strokeWidth?: number,
    lastArrow?: {
        type?: number
        highlightSize?: number
     ...
     * @defaultValue '5%'
     */
    ticksAutoPosThreshold?: number | string
...
export interface BisectorOptions {
    ...
    strokeColor?: string // Bisector line
...
export interface BisectorlinesOptions {
    /**#@+
     * @visprop
     */
...
export interface CardinalsplineOptions {
    /**#@+
     * @visprop
     */
...
export interface CircumcircleOptions {
    /**#@+
     * @visprop
     */
...
export interface CircumcirclearcOptions {
    /**#@+
     * @visprop
     */
 ...
 */
     ...
     * @defaultValue 1600
     */
    numberPointsHigh?: number,  // Number of points on curves after mouseUp
     ...
     * @defaultValue 400
     */
    numberPointsLow?: number,    // Number of points on curves after mousemove
...
export interface GridOptions extends CurveOptions {
    needsRegularUpdate?: boolean
    hasGrid?: boolean  // Used in standardoptions
    highlight?: boolean
...
export interface LegendOptions {
     ...
     * @name Legend#colors
     * @type Array
     * @defaultValue "['#B02B2C', '#3F4C6B', '#C79810', '#D15600', '#FFFF88', '#c3d9ff', '#4096EE', '#008C00']"
     */
    colors?: string[]
...
export interface PointOptions {
     ...
     * @defaultValue circle
     */
    face?: string   // TODO: allowed values?
     ...
     *
     */
    zoom?: boolean             // Change the point size on zoom
     ...
     * @defaultValue 'user'
     */
    attractorUnit?: 'user' | 'screen'    // 'screen', 'user'
...
export interface TextOptions /*extends GeometryElementOptions*/ {
     ...
     *
     */
    fontUnit?: 'px' | 'pt' | 'em' | 'rem' | 'ex' | 'ch' | 'vw' | 'vh' | 'vmin' | 'vmax'
     ...
     * @type Boolean
     */
    useCaja?: boolean // TODO: Caja no longer supported
     ...
     * @memberOf Text.prototype
     * @defaultValue  'font-family: Arial, Helvetica, Geneva, sans-serif;'
     * @type String
    ...
    */
     ...
     * @type String
     */
    anchorX?: 'auto' | 'left' | 'middle' | 'right'
     ...
     * @type String
     */
    anchorY?: 'auto' | 'top' | 'middle' | 'bottom'
