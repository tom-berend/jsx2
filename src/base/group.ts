 ...
 * @constructor
 */
JXG2.Group = function (board, id, name, objects, attributes) {
...
JXG2.extend(
    JXG2.Group.prototype,
    /** @lends JXG2.Group.prototype */ {
        /**
        ...
        update: function () {
            ...
            if (drag.action === 'translation') {
                ...
                if (Type.exists(this[actionCenter].coords)) {
                    ...
                    JXG2.debug('Group.update: No valid center for this transformation, get out of here.');
                    return this;
                }
        ...
        */
        ...
        setProperty: function () {
            JXG2.deprecated("Group.setProperty", "Group.setAttribute()");
 ...
 * </script><pre>
 */
JXG2.createGroup = function (board, parents, attributes) {
    var attr = Type.copyAttributes(attributes, board.options, 'group'),
        g = new JXG2.Group(board, attr.id, attr.name, parents, attr);
...
JXG2.registerElement("group", JXG2.createGroup);

export default JXG2.Group;
// export default {
//     Group: JXG2.Group,
//     createGroup: JXG2.createGroup
// };
