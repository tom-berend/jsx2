...
export class Polygon extends GeometryElement {
        ...
        if (this.visPropCalc.visible) {
            ...
            if (!this.isReal) {
                ...
                for (i in this.childElements) {
                    if (this.childElements.hasOwnProperty(i)) {   // tbtb - what does does mean??
     ...
     */
    hideElement(borderless = false): GeometryElement {
        var i;
     ...
     */
    showElement(borderless = false): GeometryElement {
        var i;
 ...
 *
 */
export function createPolygon(board, parents, attributes) {
    var el, i, le, obj,
        points: Point[] | false = [],
        attr,
        attr_points,
 ...
 *
 */
export function createRegularPolygon(board, parents, attributes) {
    var el, i, n,
        p: Point[] | false = [],
        rot, len,
        pointsExist,
 ...
 *
 */
export function createPolygonalChain(board, parents, attributes) {
    var attr, el;
 ...
 *
 */
export function createParallelogram(board, parents, attributes) {
    var el, pp,
        points: Point[] | false = [],
        attr,
        attr_pp;
