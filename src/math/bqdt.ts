...
export class BoxQuadtree {
    ...
    constructor(depth, capacity, bbox?) {
        var l, t, r, b;
        this.depth = depth
    ...
    subdivide(nw_it, sw_it, ne_it, se_it, l, t, r, b) {
        if (nw_it.length > 0) {
            if (this.northWest === null) {
                this.northWest = new BoxQuadtree(this.depth-1, this.capacity, [l, t, this.cx, this.cy]);
            }
            this.northWest.insert(nw_it);
        }
        if (sw_it.length > 0) {
            if (this.southWest === null) {
                this.southWest = new BoxQuadtree(this.depth-1, this.capacity, [l, this.cy, this.cx, b]);
            }
            this.southWest.insert(sw_it);
        }
        if (ne_it.length > 0) {
            if (this.northEast === null) {
                this.northEast = new BoxQuadtree(this.depth-1, this.capacity, [this.cx, t, r, this.cy]);
            }
            this.northEast.insert(ne_it);
        }
        if (se_it.length > 0) {
            if (this.southEast === null) {
                this.southEast = new BoxQuadtree(this.depth-1, this.capacity, [this.cx, this.cy, r, b]);
            }
